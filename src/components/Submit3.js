  ...
  return (
    <div className="submit2">
      <form className="form" onSubmit={formik.handleSubmit}>
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} md={4}>
                  <TextField 
                    fullWidth 
                    placeholder='Middle name'
                    {...formik.getFieldProps("field9")}
                  />
                  {formik.touched.field9 && formik.errors.field9 ? (
                    <div className="is-invalid">{formik.errors.field9}</div>
                  ) : null}
                </Grid>
                <Grid item xs={12} md={4}>
                  <TextField 
                    fullWidth 
                    placeholder='Last name'
                    {...formik.getFieldProps("field10")}
                  />
                  {formik.touched.field10 && formik.errors.field10 ? (
                    <div className="is-invalid">{formik.errors.field10}</div>
                  ) : null}
                </Grid>
              </Grid>
              <Grid 
              ...
              >
                <Grid item xs={12} md={4}>
                  <TextField 
                    fullWidth 
                    placeholder='Enter your Email Id'
                    {...formik.getFieldProps("field11")}
                  />
                  {formik.touched.field11 && formik.errors.field11 ? (
                    <div className="is-invalid">{formik.errors.field11}</div>
                  ) : null}
                </Grid>
                <Grid item xs={12} md={4}>
                  <TextField 
                    fullWidth 
                    placeholder='Enter your Mobile Number'
                    {...formik.getFieldProps("field12")}
                  />
                  {formik.touched.field12 && formik.errors.field12 ? (
                    <div className="is-invalid">{formik.errors.field12}</div>
                  ) : null}
                </Grid>
              </Grid>
              <Grid 
              ...
              >
                <Grid item xs={12} md={4}>
                  <TextField 
                    fullWidth 
                    placeholder='Enter your Adhaar Number'
                    {...formik.getFieldProps("field13")}
                  />
                  {formik.touched.field13 && formik.errors.field13 ? (
                    <div className="is-invalid">{formik.errors.field13}</div>
                  ) : null}
                </Grid>
                <Grid item xs={12} md={4}>
                  <label htmlFor="upload-photo">
              ...
              >
                <Grid item xs={12} md={4}>
                  <TextField 
                    fullWidth 
                    placeholder='Enter your Pan Card Number'
                    {...formik.getFieldProps("field14")}
                  />
                  {formik.touched.field14 && formik.errors.field14 ? (
                    <div className="is-invalid">{formik.errors.field14}</div>
                  ) : null}
                </Grid>
                <Grid item xs={12} md={4}>
                  <label htmlFor="upload-photo">
        ...
        >
          <div className="header" onClick={()=>setShowHome3(!showHome3)} >
            ...
            <div className="body2">
              <div className='body_field'>
                <TextField 
                  fullWidth 
                  placeholder='First name'
                  {...formik.getFieldProps("field15")}
                />
                {formik.touched.field15 && formik.errors.field15 ? (
                  <div className="is-invalid">{formik.errors.field15}</div>
                ) : null}
                <Grid
                  container 
                  spacing={2}
